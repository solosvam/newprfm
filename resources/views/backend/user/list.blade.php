@php
    $html_tag_data = [];
    $title = 'Admin siyahısı';
    $breadcrumbs = ["/"=>"ParfumShop", ""=>"Əməkdaşlar"]
@endphp
                        ...
                        <div class="card-body">
                            ...
                            <table class="data-table data-table-pagination data-table-standard responsive nowrap hover" id="datatableHover" data-order='[[ 0, "desc" ]]'>
                                ...
                                <tr>
                                    ...
                                    <th class="text-muted text-small text-uppercase">ROLU</th>
                                ...
                                @foreach($users as $user)
                                    <tr>
                                        ...
                                        <td>{{$user->name}}</td>
                                        <td class="text-alternate">{{$user->surname}}</td>
                                        <td class="text-alternate">{{$user->email}}</td>
                                        <td class="text-alternate">{{$user->mobile}}</td>
                                        <td class="text-alternate">{{$user->active ? 'Aktiv' : 'Deaktiv' }}</td>
                                        <td class="text-alternate">{{$user->getRoleNames()->first()}}</td>
