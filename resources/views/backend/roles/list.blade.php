        ...
        <div class="row">
            <div class="col">
                <section class="scroll-section" id="userButtons">
                    <h2 class="small-title">Rollar</h2>
                                ...
                                <div class="card-body">
                                    <div class="row g-0 h-100 align-content-center mb-2 custom-sort d-none d-sm-flex">
                                        <div class="col-4 col-sm-6 d-flex align-items-center">
                                            <div class="text-small">ROL ADI</div>
                                        </div>
                                        <div class="col-4 col-sm-3 d-flex align-items-center">
                                            <div class="text-small">DETALLAR</div>
                                        </div>
                                                ...
                                                <div class="h-auto sh-sm-5 mb-3 mb-sm-0 scroll-child">
                                                    <div class="row g-0 h-100 align-content-center">
                                                        ...
                                                        <div class="col-12 col-sm-3 d-flex align-items-center justify-content-sm-end text-muted sale">
                                                            <a href="{{route('admin.role.permissions',$role->id)}}" class="btn btn-outline-secondary btn-sm ms-1" type="button">Icazələr</a>
                                                            <a href="{{route('admin.role.edit',$role->id)}}" class="btn btn-outline-secondary btn-sm ms-1" type="button">Edit</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            @endforeach
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="POST" action="{{route('admin.role.add')}}">
                            @csrf
                            <label>Rol adı</label>
                            <input type="text" name="name" class="form-control" placeholder="Rol adı" value="{{old('name')}}" required>
                            <label>Rol haqqında məlumat</label>
                            <input type="text" name="description" class="form-control" placeholder="Rol haqqında məlumat" value="{{old('description')}}" required>
