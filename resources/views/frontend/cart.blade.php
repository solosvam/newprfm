...
<main><div class="container"><div class="cart-page">
    ...
    <div class="cart-layout">
        ...
        <aside class="cart-summary">
            ...
            <button type="button">Sifarişi rəsmiləşdir</button>
        </aside>
    </div>
