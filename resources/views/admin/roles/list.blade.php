                                                ...
                                                <div class="h-auto sh-sm-5 mb-3 mb-sm-0 scroll-child">
                                                    <div class="row g-0 h-100 align-content-center">
                                                        ...
                                                        <div class="col-12 col-sm-3 d-flex align-items-center justify-content-sm-end text-muted sale">
                                                            <a href="{{route('role.permissions',$role->id)}}" class="btn btn-outline-secondary btn-sm ms-1" type="button">Icazələr</a>
                                                            <a href="{{route('role.edit',$role->id)}}" class="btn btn-outline-secondary btn-sm ms-1" type="button">Edit</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            @endforeach
