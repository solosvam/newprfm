                ...
                <section class="scroll-section" id="userButtons">
                    <div class="card">
                        <div class="card-body mb-n2" id="existingHtmlList">
                                    ...
                                    <div class="col">
                                        <div class="card-body d-flex flex-row pt-0 pb-0 ps-3 pe-0 h-100 align-items-center justify-content-between">
                                            <div class="d-flex flex-column">
                                                <div class="name">{{$banner->device}} {{$banner->location}}</div>
                                                <div class="text-small position">{{ $banner->active ? 'Aktiv' : 'Deaktiv' }}</div>
                                            </div>
                                            <div class="d-flex">
                                                <a href="{{route('banner.edit',$banner->id)}}" class="btn btn-outline-primary btn-sm ms-1">Edit</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            {{$banners->links('admin.pagination')}}
                        </div>
                    </div>
                </section>
            </div>
